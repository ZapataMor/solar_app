@php
    ...
    // Radiation source (prefer Ambient, fallback to station, then NASA)
    $avgRadiation = null;
    $radiationSource = 'none';
    if (!empty($ambientWeatherStats['averageRadiation'])) {
    ...
    // Solar condition scene
    $heroScene = $avgRadiation !== null && $avgRadiation >= 550 ? 'high'
        : ($avgRadiation !== null && $avgRadiation >= 250 ? 'medium' : 'low');
...
.sdash-hero-stage { padding: 1rem; }
.sdash-hero-stage .solar-hero-scene-viewport { min-height: 260px; }
...
>>>>>>> 2de8c01660b3dc44fb91bb95dfe7857076f23d55
    ...
    <div class="sdash-card sdash-hero-stage">
        <div class="solar-hero-scene-card">
            <div class="solar-hero-scene-viewport solar-hero-scene-{{ $heroScene }}">
                <div class="solar-hero-sky"></div>
                <div class="solar-hero-sun-glow"></div>
                <div class="solar-hero-sun-core"></div>
                <span class="solar-hero-cloud solar-hero-cloud-a"></span>
